...
object LanguageManager {
    private val message: Map<String, Map<MessageKey, String>> = mapOf(
        "ja" to mapOf(
            ...
            MessageKey.NO_ENDER_CHEST_IN_INVENTORY to "エンダーチェストがインベントリにありません。",
        ...
        "en" to mapOf(
            ...
            MessageKey.NO_ENDER_CHEST_IN_INVENTORY to "No ender chest in inventory.",
        ...
        "zh" to mapOf(
            ...
            MessageKey.NO_ENDER_CHEST_IN_INVENTORY to "背包中没有末影箱。",
        ...
        "fr" to mapOf(
            ...
            MessageKey.NO_ENDER_CHEST_IN_INVENTORY to "Aucun coffre de l'End dans l'inventaire.",
        ...
        "de" to mapOf(
            ...
            MessageKey.NO_ENDER_CHEST_IN_INVENTORY to "Keine Endertruhe im Inventar.",
        ...
        "es" to mapOf(
            ...
            MessageKey.NO_ENDER_CHEST_IN_INVENTORY to "No hay cofre del End en el inventario.",
        ...
        "it" to mapOf(
            ...
            MessageKey.NO_ENDER_CHEST_IN_INVENTORY to "Nessun Ender Chest nell'inventario.",
        ...
        "ko" to mapOf(
            ...
            MessageKey.NO_ENDER_CHEST_IN_INVENTORY to "인벤토리에 엔더 상자가 없습니다.",
